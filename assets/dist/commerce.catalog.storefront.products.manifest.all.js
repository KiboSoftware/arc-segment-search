...
module.exports = {
    'http.commerce.catalog.storefront.productsearch.search.before': {
        actionName: 'http.commerce.catalog.storefront.productsearch.search.before',
        customFunction: require('./domains/search/http.commerce.catalog.storefront.productsearch.search.before')
    }
  };
  
},{"./domains/search/http.commerce.catalog.storefront.productsearch.search.before":2}],2:[function(require,module,exports){
...
},{"mozu-node-sdk/client":4,"mozu-node-sdk/clients/commerce/customer/accounts/customerSegment":5}],3:[function(require,module,exports){
module.exports={
  "Production/Sandbox": {
...
},{"./constants":10,"./plugins/expand-uritemplate-from-context":11,"./plugins/in-memory-auth-cache":12,"./plugins/server-side-prerequisites":18,"./utils/get-config":23,"./utils/make-method":25,"./utils/normalize-context":26,"./utils/sub":30,"./utils/tiny-extend":32}],5:[function(require,module,exports){
...
},{"../../../client":4}],9:[function(require,module,exports){
...
},{"../../client":4}],10:[function(require,module,exports){
'use strict';
...
},{"../../utils/get-url-template":24,"../../utils/tenant-cache":31,"./get-scope-from-state":17,"mozu-metadata/data/environments.json":3}],15:[function(require,module,exports){
'use strict';
...
},{"../clients/platform/adminuser/tenantAdminUserAuthTicket":6,"../clients/platform/applications/authTicket":7,"../clients/platform/developer/developerAdminUserAuthTicket":8,"../constants":10,"../utils/tenant-cache":31,"./auth-ticket":20}],20:[function(require,module,exports){
'use strict';
...
},{"../constants":10,"./errorify":22,"./parse-json-dates":27,"./stream-to-callback":29,"./tiny-extend":32,"http":undefined,"https":undefined,"url":undefined,"zlib":undefined}],29:[function(require,module,exports){
'use strict';
...
},{"zlib":undefined}],30:[function(require,module,exports){
'use strict';
